...
import OpenGL_6_Shader.Model.VboCube;
import OpenGL_6_Shader.obj.Esfera3D;
import OpenGL_6_Shader.obj.ObjModel;
import OpenGL_6_Shader.obj.Personagem;
import OpenGL_6_Shader.shaders.ShaderProgram;
import OpenGL_6_Shader.shaders.StaticShader;
import OpenGL_6_Shader.util.TextureLoader;
...
//	float posZ = -2.0f;
	...
	public void run() {
		...
		tankobj.loadObj("src/OpenGL_6_Shader/res/x-35_obj.obj");
		//tankobj.createTextureBase("src/OpenGL_6_Shader/res//x-35_obj.jpg", 1024, 1024);
...
//				posZ+=0.1f;
	...
	private void loop() {
		...
		BufferedImage bfm1 = TextureLoader.loadImage("src/OpenGL_6_Shader/res/gatinho01.jpg");
		texturaDoGatinho = TextureLoader.loadTexture(bfm1);
		BufferedImage bfm2 = TextureLoader.loadImage("src/OpenGL_6_Shader/res/x35_b.jpg");
